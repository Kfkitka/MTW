 ...
 */
class SeamlessDonationsAdminPageFramework_Property_Page extends SeamlessDonationsAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aSeamlessDonationsAdminPageFramework']['aPageClasses'] = isset($GLOBALS['aSeamlessDonationsAdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aSeamlessDonationsAdminPageFramework']['aPageClasses']) ? $GLOBALS['aSeamlessDonationsAdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['aSeamlessDonationsAdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
