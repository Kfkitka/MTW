 ...
 */
abstract class SeamlessDonationsAdminPageFramework_Page_View_MetaBox extends SeamlessDonationsAdminPageFramework_Page_Model {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aSeamlessDonationsAdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aSeamlessDonationsAdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aSeamlessDonationsAdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aSeamlessDonationsAdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aSeamlessDonationsAdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['aSeamlessDonationsAdminPageFramework']['bAddedMetaBoxScript'] = true;
