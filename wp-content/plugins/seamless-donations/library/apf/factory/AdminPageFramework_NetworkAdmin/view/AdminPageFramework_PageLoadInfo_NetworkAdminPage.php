 ...
 */
class SeamlessDonationsAdminPageFramework_PageLoadInfo_NetworkAdminPage extends SeamlessDonationsAdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new SeamlessDonationsAdminPageFramework_PageLoadInfo_NetworkAdminPage($oProp, $oMsg);
