 ...
 */
abstract class SeamlessDonationsAdminPageFramework_MetaBox extends SeamlessDonationsAdminPageFramework_MetaBox_Controller {
    ...
    function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new SeamlessDonationsAdminPageFramework_Property_MetaBox($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
