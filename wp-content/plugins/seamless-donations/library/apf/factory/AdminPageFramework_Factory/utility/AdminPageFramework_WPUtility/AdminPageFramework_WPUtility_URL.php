 ...
 */
class SeamlessDonationsAdminPageFramework_WPUtility_URL extends SeamlessDonationsAdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(SeamlessDonationsAdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(SeamlessDonationsAdminPageFramework_WPUtility_Page::getPageNow());
