 ...
 */
abstract class SeamlessDonationsAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['aSeamlessDonationsAdminPageFramework'] = isset($GLOBALS['aSeamlessDonationsAdminPageFramework']) && is_array($GLOBALS['aSeamlessDonationsAdminPageFramework']) ? $GLOBALS['aSeamlessDonationsAdminPageFramework'] : array('aFieldFlags' => array());
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => SeamlessDonationsAdminPageFramework_Registry::NAME, 'sURI' => SeamlessDonationsAdminPageFramework_Registry::URI, 'sScriptName' => SeamlessDonationsAdminPageFramework_Registry::NAME, 'sLibraryName' => SeamlessDonationsAdminPageFramework_Registry::NAME, 'sLibraryURI' => SeamlessDonationsAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => SeamlessDonationsAdminPageFramework_Registry::getVersion(), 'sDescription' => SeamlessDonationsAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => SeamlessDonationsAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => SeamlessDonationsAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => SeamlessDonationsAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => SeamlessDonationsAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
