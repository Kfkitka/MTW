 ...
 */
class SeamlessDonationsAdminPageFramework_FieldType_radio extends SeamlessDonationsAdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        $_oRadio = new SeamlessDonationsAdminPageFramework_Input_radio($aField['attributes']);
