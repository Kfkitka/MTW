...
abstract class SeamlessDonationsAdminPageFramework_Registry_Base {
    const VERSION = '3.5.6';
...
final class SeamlessDonationsAdminPageFramework_Registry extends SeamlessDonationsAdminPageFramework_Registry_Base {
    ...
    static public function setUp($sFilePath = __FILE__) {
        ...
        self::$sAutoLoaderPath = isset(self::$aClassFiles['SeamlessDonationsAdminPageFramework_RegisterClasses']) ? self::$aClassFiles['SeamlessDonationsAdminPageFramework_RegisterClasses'] : '';
        self::$bIsMinifiedVersion = class_exists('SeamlessDonationsAdminPageFramework_MinifiedVersionHeader');
    }
...
final class SeamlessDonationsAdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath = __FILE__) {
        if (!$this->_isLoadable()) {
            return;
        }
        SeamlessDonationsAdminPageFramework_Registry::setUp($sLibraryPath);
        if (SeamlessDonationsAdminPageFramework_Registry::$bIsMinifiedVersion) {
            return;
        }
        include (SeamlessDonationsAdminPageFramework_Registry::$sAutoLoaderPath);
        new SeamlessDonationsAdminPageFramework_RegisterClasses(empty(SeamlessDonationsAdminPageFramework_Registry::$aClassFiles) ? SeamlessDonationsAdminPageFramework_Registry::$sDirPath : '', array('exclude_class_names' => array('SeamlessDonationsAdminPageFramework_MinifiedVersionHeader', 'SeamlessDonationsAdminPageFramework_BeautifiedVersionHeader',),), SeamlessDonationsAdminPageFramework_Registry::$aClassFiles);
        SeamlessDonationsAdminPageFramework_Registry::$bIsDevelopmentVersion = class_exists('SeamlessDonationsAdminPageFramework_InclusionClassFilesHeader');
    }
...
new SeamlessDonationsAdminPageFramework_Bootstrap(__FILE__);