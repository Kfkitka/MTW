...
<aside id="sidebar" class="mtwSidebar floatLeft">

	<article class="imgSidebar"><img src="<?php echo $homePage ?>wp-content/images/<?php echo $subUrl ?>/sidebar<?php echo $currentTitleImg ?>.png" alt="sidebar image" /></article>

    <article class="sidebarContent">

		<?php /*if ($currentTitle == "About Us"): ?>

        	<p class="sidebarTitle">CREATIVE EXPRESSION</p>

            <p>From school-based curriculum to corporate meetings, all of our programs use creative movement, as experienced&mdash;for example, in dance or theater&mdash;as the vehicle for teaching and learning. Through movement, our participants develop a stronger connection to their bodies which helps them to identify and express emotions and resolve conflicts with others.</p>
        ...
        <?php /*<?php if ($currentTitle == "School Programs"): ?>

            <p><i>&ldquo;As we work to improve our students&rsquo; reading skills and enhance their ability to comprehensively process information, it is important that our students feel comfortable and confident within themselves. Move This World has been incredibly effective in engaging students who are academically lower than their peers. The kinesthetic component of the program has allowed such students a unique opportunity to shine. These students have shown improvements cognitively and creatively, unlike what we have observed in the normal classroom structure. Move This World brings out a different side of our students; for the first time we are seeing students who normally never raise their hands in class, eagerly volunteer answers and feel that they too have something valuable to contribute to discussions.&rdquo;</i></p>

            <p>-Altavia Ray, Program Director of the Literacy Lab</p>
