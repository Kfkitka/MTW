 ...
 */
abstract class SeamlessDonationsAdminPageFramework_Form_Model_Export extends SeamlessDonationsAdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new SeamlessDonationsAdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
