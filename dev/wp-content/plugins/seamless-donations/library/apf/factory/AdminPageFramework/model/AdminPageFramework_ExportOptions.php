 ...
 */
class SeamlessDonationsAdminPageFramework_ExportOptions extends SeamlessDonationsAdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo SeamlessDonationsAdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
