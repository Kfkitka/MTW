 ...
 */
abstract class SeamlessDonationsAdminPageFramework_Form_Model_Import extends SeamlessDonationsAdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new SeamlessDonationsAdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
