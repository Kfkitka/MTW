 ...
 */
class SeamlessDonationsAdminPageFramework_Link_Page extends SeamlessDonationsAdminPageFramework_Link_Base {
    public $oProp;
    ...
    private function _addFilterHook_PluginTitleActionLink() {
        ...
        add_filter($this->_sFilterSuffix_PluginActionLinks . $_sPluginBaseName, array($this, '_replyToAddLinkToPluginTitle'));
    }
    public function _replyToAddInfoInFooterLeft($sLinkHTML = '') {
        ...
        return $this->addAndApplyFilters($this->oProp->_getCallerObject(), array($this->getAOrB($_sTabSlug, 'footer_left_' . $_sPageSlug . '_' . $_sTabSlug, null), 'footer_left_' . $_sPageSlug, 'footer_left_' . $this->oProp->sClassName), $sLinkHTML);
    }
    public function _replyToAddInfoInFooterRight($sLinkHTML = '') {
        ...
        $_sPageSlug = $this->oProp->getCurrentPageSlug();
        $_sTabSlug = $this->oProp->getCurrentTabSlug();
        return $this->addAndApplyFilters($this->oProp->_getCallerObject(), array($this->getAOrB($_sTabSlug, 'footer_right_' . $_sPageSlug . '_' . $_sTabSlug, null), 'footer_right_' . $_sPageSlug, 'footer_right_' . $this->oProp->sClassName), $this->oProp->aFooterInfo['sRight']);
    }
