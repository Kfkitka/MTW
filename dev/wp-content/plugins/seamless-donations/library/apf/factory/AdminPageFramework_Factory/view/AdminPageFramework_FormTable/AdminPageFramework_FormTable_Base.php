 ...
 */
class SeamlessDonationsAdminPageFramework_FormTable_Base extends SeamlessDonationsAdminPageFramework_FormOutput {
    ...
    private function _loadScripts() {
        ...
        new SeamlessDonationsAdminPageFramework_Script_Tab;
    }
...
JAVASCRIPTS;
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        new SeamlessDonationsAdminPageFramework_Script_CollapsibleSection($this->oMsg);
    }
    ...
    protected function _getRepeatableSectionsEnablerScript($sContainerTagID, $iSectionCount, $aSettings) {
        ...
        new SeamlessDonationsAdminPageFramework_Script_RepeatableSection($this->oMsg);
...
JAVASCRIPTS;
    ...
    protected function _getDebugInfo($sFieldsType) {
        ...
        return "<div class='admin-page-framework-info'>" . 'Debug Info: ' . SeamlessDonationsAdminPageFramework_Registry::NAME . ' ' . SeamlessDonationsAdminPageFramework_Registry::getVersion() . "</div>";
    }
}