 ...
 */
class SeamlessDonationsAdminPageFramework_FieldType_checkbox extends SeamlessDonationsAdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        $_oCheckbox = new SeamlessDonationsAdminPageFramework_Input_checkbox($aField['attributes']);
