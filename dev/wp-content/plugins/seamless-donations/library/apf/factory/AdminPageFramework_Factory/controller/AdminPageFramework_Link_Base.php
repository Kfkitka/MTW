 ...
 */
abstract class SeamlessDonationsAdminPageFramework_Link_Base extends SeamlessDonationsAdminPageFramework_WPUtility {
    ...
    private function _getFooterInfoRight($aScriptInfo) {
        ...
        return $this->oMsg->get('powered_by') . '&nbsp;' . $_sLibraryInfo . ",&nbsp;" . $this->generateHTMLTag('a', array('href' => 'https://wordpress.org', 'target' => '_blank', 'title' => 'WordPress' . $GLOBALS['wp_version']), 'WordPress');
    }
    ...
    public function _replyToAddInfoInFooterLeft($sLinkHTML = '') {
        ...
        return $this->addAndApplyFilters($this->oProp->_getCallerObject(), 'footer_left_' . $this->oProp->sClassName, $sLinkHTML);
    }
    public function _replyToAddInfoInFooterRight($sLinkHTML = '') {
        return $this->addAndApplyFilters($this->oProp->_getCallerObject(), 'footer_right_' . $this->oProp->sClassName, $this->oProp->aFooterInfo['sRight']);
    }
}