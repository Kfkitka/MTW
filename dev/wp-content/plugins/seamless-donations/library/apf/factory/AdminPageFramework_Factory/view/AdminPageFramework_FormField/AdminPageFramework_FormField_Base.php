 ...
 */
abstract class SeamlessDonationsAdminPageFramework_FormField_Base extends SeamlessDonationsAdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new SeamlessDonationsAdminPageFramework_Script_Widget;
        ...
        new SeamlessDonationsAdminPageFramework_Script_Utility;
        new SeamlessDonationsAdminPageFramework_Script_OptionStorage;
        new SeamlessDonationsAdminPageFramework_Script_AttributeUpdator;
        new SeamlessDonationsAdminPageFramework_Script_RepeatableField($this->oMsg);
        new SeamlessDonationsAdminPageFramework_Script_Sortable;
        new SeamlessDonationsAdminPageFramework_Script_RegisterCallback;
    }
