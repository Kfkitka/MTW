 ...
 */
class SeamlessDonationsAdminPageFramework_FieldType_system extends SeamlessDonationsAdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getPHPInfo($bGenerateInfo = true) {
        ...
        $_oErrorReporting = new SeamlessDonationsAdminPageFramework_ErrorReporting;
