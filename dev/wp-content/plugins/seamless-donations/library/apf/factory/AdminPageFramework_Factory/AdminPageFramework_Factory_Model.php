 ...
 */
abstract class SeamlessDonationsAdminPageFramework_Factory_Model extends SeamlessDonationsAdminPageFramework_Factory_Router {
    ...
    protected function _registerField(array $aField) {
        SeamlessDonationsAdminPageFramework_FieldTypeRegistration::_setFieldResources($aField, $this->oProp, $this->oResource);
        if ($aField['help']) {
    ...
    protected function _isValidationErrors() {
        if (isset($GLOBALS['aSeamlessDonationsAdminPageFramework']['aFieldErrors']) && $GLOBALS['aSeamlessDonationsAdminPageFramework']['aFieldErrors']) {
            return true;
        }
    ...
    public function _replyToSaveFieldErrors() {
        if (!isset($GLOBALS['aSeamlessDonationsAdminPageFramework']['aFieldErrors'])) {
            return;
        }
        $this->oUtil->setTransient("apf_field_erros_" . get_current_user_id(), $GLOBALS['aSeamlessDonationsAdminPageFramework']['aFieldErrors'], 300);
    }
    public function _replyToSaveNotices() {
        if (!isset($GLOBALS['aSeamlessDonationsAdminPageFramework']['aNotices'])) {
            return;
        }
        if (empty($GLOBALS['aSeamlessDonationsAdminPageFramework']['aNotices'])) {
            return;
        }
        $this->oUtil->setTransient('apf_notices_' . get_current_user_id(), $GLOBALS['aSeamlessDonationsAdminPageFramework']['aNotices']);
    }
