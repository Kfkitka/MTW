 ...
 */
abstract class SeamlessDonationsAdminPageFramework_MetaBox_Page_Model extends SeamlessDonationsAdminPageFramework_MetaBox_Page_Router {
    ...
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new SeamlessDonationsAdminPageFramework_Property_MetaBox_Page($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
